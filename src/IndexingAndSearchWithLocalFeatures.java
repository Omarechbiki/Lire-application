...
import net.semanticmetadata.lire.imageanalysis.features.global.CvDFT;
...
public class IndexingAndSearchWithLocalFeatures {
     ...
     * @throws IOException
     */
    public static void search(String indexPath, String searchFile) throws IOException {
        IndexReader reader = DirectoryReader.open(FSDirectory.open(Paths.get(indexPath)));

        // make sure that this matches what you used for indexing (see below) ...
        ImageSearcher imgSearcher = new GenericFastImageSearcher(1000, CvDFT.class, true, reader, True);
    ...
    /**
     * Indexing data using the DFT from OpenCV
     * @param index
    ...
    public static void index(String index, String imageDirectory) {
        ...
        //global DFT feature
        indexer.addExtractor(CvDFT.class);
        indexer.run();
